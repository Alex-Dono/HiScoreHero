...
public class OutlineLabel extends JLabel {
    ...
    public void colorsFontandSizeSetter(Color outlineeColor, Color textColor, int size, String font, int fontType){
        setOutlineColor(outlineeColor);
        setForeground(textColor);
        setOpaque(true);
        setFont(new Font(font, fontType, size));
    }
